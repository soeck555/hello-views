...
public class var_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 명령문의 조합
		 * 명령문은키워드1 키워드2 키워드3 처럼 빈칸으로 키워드를 구분하거나
		 ...
		 * System.out.println()
		 * PrintWritet.println()
		 * PrintWritet.out.println()
		 */
		// method는 키워드 ()형태로 사용을 하며
		// 다른 키워드와조합으로 명령문을 완성한다
		// () 안에 어떤 값을 첨가하는데
